...
export default async function CourseByEmail() {
    return (
        <div className={styles.container}>
            <div className={styles.courseByEmailContainer}>
                <span className={styles.courseByEmailLabel}>
                    <FontAwesomeIcon className={styles.courseByEmailIcon} icon={faEnvelopeOpenText}
