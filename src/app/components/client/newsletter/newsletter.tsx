...
export const Newsletter = ({hideEntry = false}:{hideEntry?:boolean}) => {
    ...
    return <div className={styles.container} id={'newsletter'}>
        <div className={styles.header}>
            <h2 className={styles.title}>La newsletter de los <strong>Software Crafters</strong>,<br/> por Miguel A. Gómez</h2>
            ...
            <div className={styles.content}>
                <div className={styles.textContainer}>
                    <p className={styles.text}>Cada lunes, miércoles y viernes escribo un email con <strong>un consejo para subir de nivel como developer</strong>. Semana que estás fuera, consejos que te pierdes.</p>
                    <p className={styles.text}>Aprenderás a escribir mejor código gracias a arquitectos en torres de marfil, barcos que se hunden y a developers que desarrollan lenguajes en 10 días ... </p>
