...
const routes: string[] = [
    ...
    '/typescript/patrones-diseno-creacionales-estructurales',
    '/devops/docker-nodejs-buenas-practicas',
    '/react/tdd-react-typescript',
    '/typescript/introduccion-typescript-react',
    '/typescript/patrones-diseno-comportamiento-ui',
    '/vuejs/aumenta-productividad-vuex-typescript',
    '/react/testing-frontend',
    '/typescript/inyeccion-de-dependencias-componentes',
    '/css/postcss-preset-env-babel-css',
    '/javascript/tdd-test-driven-development',
    '/css/css-craftsmanship',
    '/javascript/clean-code-javascript',
    '/javascript/introduccion-programacion-reactiva-rxjs',
    '/typescript/union-types-pattern-matching-typescript',
    '/typescript/typescript-tutorial-javascript-introduccion',
    '/react/tutorial-react-js-introduccion',
    '/python/principios-solid-python',
    '/xamarin/patron-mvvm-xamarin-forms',
    '/xamarin/xamarin-forms-apps-nativas-introduccion',
    '/python/tutorial-de-python-introduccion',
    '/configurar-servidor-https-nginx',
